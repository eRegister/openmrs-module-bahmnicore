...
public class BahmniMpiPatientSearchController extends BaseRestController {
    ...
    // The localIdentifierTypes in Bahmni will always be the same for all sites, the difference is with the MPI Identifier Type Map
    ...
    // NB: Ignore HashMap approach since i.e. defaulting to one patient identifier type across sites???
    ...
    public ResponseEntity<PatientContract> importPatient(@RequestParam(value = "patientEcid", required = true) String patientEcid) {
        ...
        // NEED TO REFACTOR THIS APPROACH TO SWITCH FROM Reflection approach to Context.getService()!!!
        Object registrationCoreService = applicationContext.getBean("registrationCoreService");
